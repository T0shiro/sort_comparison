...
arrayToSort = 1..5
sorting_algorithms = [new insertion_sort(), new heap_sort(), new merge_sort(), new quick_sort(algorithms.quick_sort.Pivot.FIRST), new quick_sort(algorithms.quick_sort.Pivot.RANDOM), new quick_sort(algorithms.quick_sort.Pivot.MEDIAN3), new quick_sort(algorithms.quick_sort.Pivot.MEDIAN5), new smooth_sort()]
